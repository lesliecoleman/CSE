...
class Sword(Weapons):
    def __init__(self):
        super(Sword, self).__init__('Sword', False, 100, 100, False, False, False)

class Knife(Weapons):
    def __init__(self):
        super(Knife, self).__init__('Knife', False, 20, 20, False, False, False)
...
class Otherwearables(key_items):
    def __init__(self):
        super(Otherwearables, self).__init__()
...
while response not in ['yes', 'no']:
    ...
    if response.lower() == 'yes':
        ...
        print("Welcome. Here is some basic information."
              ...
              "\nCommands:"
              "\nLook, Quit, Party, Travel, Inventory, Commands, Help, pick up, drop."
              "\nDirections:"
...
while is_playing:
    ...
    if current_node == deadzone:
        ...
        if response.lower() == 'yes':
            ...
            MARSTORAGE2 = 'The markers are still there. Go upstairs or downstairs.'
            LARSTORAGE = 'You enter a dim lighted storage room. You see over 3,000 tiny rubber ducks in the room ' \
                         '\nsurrounding a the largest rubber duck in the world. You see that your armor has been ' \
                         'upgraded \nand you now have a sword to fight the ducks. \nThere is a path to the east but ' \
                         'it is shut, and a path up the stairs. \nDefeat the duck to open the door.'
            LARSTORAGE2 = 'You are back. Not quite sure if you have defeated the ducks yet. Have fun I guess... :('
            PARTY = 'You had just defeated the ducks. You walk into a party room to celebrate the win ' \
                    '\nwith all the people who live in the house and Bruce Banner. Congrats on beating the game. ' \
                    'You did a nice job.'
    ...
    if current_node == party:
        ...
        if response.lower() == 'yes':
            ...
            LARSTORAGE = 'You enter a dim lighted storage room. You see over 3,000 tiny rubber ducks in the room ' \
                         '\nsurrounding a the largest rubber duck in the world. You see that your armor has been ' \
                         'upgraded \nand you now have a sword to fight the ducks. \nThere is a path to the east ' \
                         'but it is shut, and a path up the stairs. \nDefeat the duck to open the door.'
            LARSTORAGE2 = 'You are back. Not quite sure if you have defeated the ducks yet. Have fun I guess... :('
            PARTY = 'You had just defeated the ducks. You walk into a party room to celebrate the win ' \
                    '\nwith all the people who live in the house and Bruce Banner. Congrats on beating the game. ' \
                    'You did a nice job.'
