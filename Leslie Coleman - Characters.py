...
winter_solider = Character('Bucky Barnes', 'Steve\'s best friends', None, None)
print(cap_america.description)
print(iron_man.description)
print(winter_solider.description)
iron_man.attack(cap_america)
cap_america.attack(iron_man)
iron_man.attack(winter_solider)
cap_america.attack(iron_man)
iron_man.attack(cap_america)
cap_america.attack(iron_man)
iron_man.attack(cap_america)
...
iron_man.attack(cap_america)
iron_man.attack(cap_america)
print("Bucky is devastated and runs after Tony")
winter_solider.attack(iron_man)
