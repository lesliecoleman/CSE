...
bucky_barnes = Character('Bucky Barnes', 'Steve\'s best friends', None, None)
print(cap_america.description)
print(iron_man.description)
print(bucky_barnes.description)
iron_man.attack(cap_america)
cap_america.attack(iron_man)
iron_man.attack(bucky_barnes)
cap_america.attack(iron_man)
iron_man.attack(cap_america)
cap_america.attack(iron_man)
iron_man.attack(cap_america)
